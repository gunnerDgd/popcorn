...
pp_obj* pp_obj_new      (struct pp_mem*, pp_obj_trait*, u32_t, ...)    ;
pp_obj* pp_obj_new_va   (struct pp_mem*, pp_obj_trait*, u32_t, va_list);

bool_t  pp_obj_new_at   (pp_obj*, pp_obj_trait*, u32_t, ...)    ;
bool_t  pp_obj_new_at_va(pp_obj*, pp_obj_trait*, u32_t, va_list);

pp_obj* pp_obj_clone    (pp_obj*)         ;
bool_t  pp_obj_clone_at (pp_obj*, pp_obj*);

pp_obj* pp_obj_ref      (pp_obj*);
u64_t   pp_obj_del		(pp_obj*);

pp_obj_trait* pp_obj_get_trait(pp_obj*);
u64_t         pp_obj_use_count(pp_obj*);
