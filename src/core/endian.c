...
u16_t pp_le16(u16_t par) { return par; }
u32_t pp_le32(u32_t par) { return par; }
u64_t pp_le64(u64_t par) { return par; }

MODULE_LICENSE("GPL");
EXPORT_SYMBOL (pp_be16);
EXPORT_SYMBOL (pp_be32);
EXPORT_SYMBOL (pp_be64);
EXPORT_SYMBOL (pp_le16);
EXPORT_SYMBOL (pp_le32);
EXPORT_SYMBOL (pp_le64);
#endif