function   (add_kernel_module par_name par_kernel)
    ...
    if   (PRESET_ARCH_X86_64)
        kernel_module_definition(${par_name} PRESET_LINUX)
        kernel_module_definition(${par_name} PRESET_ARCH_X86_64)
        kernel_module_definition(${par_name} PRESET_ARCH_BIT=64)
    endif()
endfunction()
